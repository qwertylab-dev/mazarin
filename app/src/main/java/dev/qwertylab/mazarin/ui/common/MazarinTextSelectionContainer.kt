...
package dev.qwertylab.mazarin.ui.common
...
/**
 * Custom Text ActionMode callback. Used in pair with [MazarinSelectionToolbar]. Follow [TextToolbar] for more info.
 */
private class MazarinTextActionModeCallback(
...
/**
 * Floating [MazarinTextActionModeCallback].
 */
private class FloatingTextActionModeCallback(
    val callback: MazarinTextActionModeCallback
 ...
 * Used in pair with [MazarinSelectionContainer] to display custom toolbar.
 */
@Suppress("DEPRECATION")
private class MazarinSelectionToolbar(
    ...
    private val callback = MazarinTextActionModeCallback(context = context)
...
fun MazarinSelectionContainer(
    ...
    val mazarinSelectionToolbar = remember {
        MazarinSelectionToolbar(
            view = view,
            context = context,
    ...
    val isToolbarHidden = remember(mazarinSelectionToolbar.status) {
        derivedStateOf {
            mazarinSelectionToolbar.status == TextToolbarStatus.Hidden
        }
    }

    CompositionLocalProvider(
        LocalTextToolbar provides mazarinSelectionToolbar
    ) {
